      ...
      <aside className="border-r border-border bg-card lg:sticky lg:top-0 lg:h-screen flex flex-col">
        ...
        <div className="p-3 border-t border-border space-y-2">
          <div className="flex items-center gap-3 px-2 py-2 rounded-lg">
            <span className="h-9 w-9 rounded-full border border-border bg-secondary grid place-items-center shrink-0">
              <span className="text-xs font-bold text-muted-foreground">{initials}</span>
            </span>
            <div className="min-w-0">
              <div className="text-sm font-medium truncate">{session?.name}</div>
              <div className="text-[11px] text-muted-foreground truncate capitalize">{session?.role}</div>
            </div>
          </div>
