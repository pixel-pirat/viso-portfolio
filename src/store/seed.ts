...
export const seedState: StudioState = {
  ...
  collaborations: [
    {
      id: "col1",
      ownerId: "seed-founder",
      ownerName: "Nadia Okafor",
      ownerEmail: "nadia@vault.example",
      title: "Vault — privacy-first knowledge base",
      summary: "End-to-end encrypted notes app for distributed product teams.",
      description: "We're building a Notion alternative where every block is encrypted client-side. Looking for a design partner and a senior backend engineer to help finalize the sync engine.",
      goals: "Ship a private beta to 10 design partners by Q3. Validate pricing and team-tier features.",
      category: "SaaS",
      tags: ["privacy", "productivity", "e2ee"],
      skillsNeeded: ["Rust", "CRDT", "Product design"],
      rolesNeeded: ["developer", "designer", "co-founder"],
      stage: "building",
      visibility: "public",
      fundingStatus: "seeking",
      fundingGoal: "$250k pre-seed",
      teamSize: 2,
      requiresNda: false,
      status: "active",
    ...
    },
    {
      ...
      ownerEmail: "tomas@orbital.example",
      title: "Orbital — AI ops copilot for SRE teams",
      summary: "An on-call assistant that summarizes incidents and drafts postmortems.",
      description: "Production-grade prototype already integrated with PagerDuty + Datadog. Need a co-founder with go-to-market experience and an angel investor for the next 12 months runway.",
      goals: "Reach 5 design-partner SRE teams. Close $400k angel round.",
      category: "AI/ML",
      tags: ["devops", "llm", "observability"],
      skillsNeeded: ["GTM", "Enterprise sales"],
      rolesNeeded: ["co-founder", "investor", "advisor"],
      stage: "validating",
      visibility: "invite_only",
      fundingStatus: "seeking",
      fundingGoal: "$400k angel",
      teamSize: 3,
      requiresNda: true,
      status: "active",
  ...
  collaborationUpdates: [
    {
      ...
      authorId: "seed-founder",
      authorName: "Nadia Okafor",
      authorRole: "founder",
      kind: "update",
      body: "Sync engine prototype now handles 10k offline edits without conflicts. Looking for designers to review onboarding flows next week.",
